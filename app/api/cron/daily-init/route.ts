...
export async function GET(req: NextRequest) {
  ...
  // CRON_SECRET is auto-generated by Vercel after first deployment with vercel.json crons.
  // If not set yet, skip the check (Vercel internal requests are still safe via middleware exemption).
